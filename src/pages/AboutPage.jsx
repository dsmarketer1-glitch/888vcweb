...
const AboutPage = () => {
  ...
  return (
    <main id="main-content" role="main" ref={pageRef}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '60px', alignItems: 'center' }}>
            <motion.div style={{ opacity: heroOpacity, y: heroY }}>
              ...
              <h1 className="text-hero" style={{ fontSize: '66px', lineHeight: '1.1', marginBottom: '32px' }}>
                Backing those <br/>
      ...
      {/* Our Story Section */}
      <section aria-label="Our Story" style={{ padding: '120px 0' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '380px 1fr', gap: '80px', alignItems: 'start' }}>
            ...
            <div style={{ color: 'white' }}>
              ...
              <h2 style={{ fontSize: '52px', fontWeight: 800, marginBottom: '16px' }}>Rohit Bafna</h2>
              <div style={{
