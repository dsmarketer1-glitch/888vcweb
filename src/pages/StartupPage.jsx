  ...
  return (
    <main id="main-content" role="main" style={{ backgroundColor: 'white' }}>
      ...
      <section aria-label="Startup program overview" style={{ backgroundColor: '#f0f4fb', padding: '100px 0 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, display: 'grid', gridTemplateColumns: '1fr 572px', gap: 40, alignItems: 'start' }}>
          {/* Left */}
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          {statsStrip.map((s, i) => (
            <React.Fragment key={i}>
              ...
              {i < statsStrip.length - 1 && <div style={{ width: 1, height: 92, backgroundColor: 'white', opacity: 0.1, flexShrink: 0 }} aria-hidden="true" />}
            </React.Fragment>
          ))}
        </div>
      </section>
      ...
      {/* ═══ 3 · WHAT YOU GET ═══ */}
      <section aria-label="Program benefits" style={{ padding: '80px 72px' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '620px 1fr', gap: 60, alignItems: 'start' }}>
          <div>
      ...
      <section aria-label="12-week accelerator program" style={{ backgroundColor: '#f5f7fc', padding: '60px 72px 80px' }}>
        <div className="container">
          ...
          {/* Timeline line */}
          <div style={{ position: 'relative' }}>
            <div style={{ position: 'absolute', top: 46, left: 86, right: 86, height: 2, backgroundColor: '#eb3a1b', opacity: 0.35 }} aria-hidden="true" />
      ...
      {/* ═══ 5 · WHO SHOULD JOIN ═══ */}
      <section aria-label="Selection criteria" style={{ padding: '40px 72px 80px' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '620px 1fr', gap: 40, alignItems: 'start' }}>
          <div>
          ...
          {/* Right — 3 images */}
          <div style={{ display: 'grid', gridTemplateColumns: '264px 1fr', gap: 16, height: 492 }}>
      ...
      <section aria-label="Portfolio companies" style={{ backgroundColor: 'var(--primary)', padding: '80px 72px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          {/* Bottom row */}
          <div style={{ display: 'grid', gridTemplateColumns: '284px 1fr', gap: 16 }}>
