    ...
    <main id="main-content" role="main" ref={pageRef} style={{ backgroundColor: 'white' }}>
      ...
      <section aria-label="Investor overview" style={{ backgroundColor: '#f0f4fb', padding: '100px 0 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container hero-grid" style={{ position: 'relative', zIndex: 1, display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 480px', gap: isMobile ? '40px' : '60px', alignItems: 'start' }}>
          ...
          {/* Right — Stat Cards */}
          <div className="mobile-grid-1" style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(auto-fit, minmax(280px, 1fr))' : '1fr', gap: 16, paddingTop: 10 }}>
            {[
      ...
      {/* ──────────────── 3 · WHY 888VC ──────────────── */}
      <section aria-label="Why invest with 888VC" style={{ padding: isMobile ? '60px 0' : '80px 72px' }}>
      ...
      {/* ──────────────── 5 · INVESTOR TYPES ──────────────── */}
      <section aria-label="Types of investors we work with" style={{ backgroundColor: 'var(--primary)', padding: isMobile ? '60px 0' : '80px 72px', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* ──────────────── 9 · GET STARTED CTA ──────────────── */}
      <section aria-label="Get started as an investor" style={{ padding: isMobile ? '60px 0' : '80px 72px' }}>
        <div className="container hero-grid" style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 568px', gap: isMobile ? '40px' : 60, alignItems: 'center' }}>
          ...
          <div className="responsive-stack" style={{
            ...
            padding: '28px',
            display: 'grid',
            gridTemplateColumns: isSmallMobile ? '1fr' : '1fr 240px',
            gap: 20,
            overflow: 'hidden',
            position: 'relative',
            minHeight: isSmallMobile ? 'auto' : 296,
          }}>
