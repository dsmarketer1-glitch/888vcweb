...
const PortfolioPage = () => {
  ...
  return (
    <main id="main-content" role="main" ref={pageRef}>
      ...
      <div style={{ borderBottom: '1px solid var(--border-muted)', backgroundColor: 'white', position: 'sticky', top: isMobile ? '60px' : '70px', zIndex: 100 }} role="search" aria-label="Filter portfolio companies">
